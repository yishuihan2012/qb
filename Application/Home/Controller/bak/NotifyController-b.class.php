    ...
    public function wxnotify(){
        ...
        if($data){
            ...
            if($data["return_code"]=="SUCCESS"){
                ...
                if($t_order=="C") {
                    ...
                    if ($check) {
                        if ($check["o_status"] == 0) {
                            ...
                            file_put_contents('a.txt', "订单：" . $data["out_trade_no"] . "不可重复操作\r\t\n", FILE_APPEND);
                        }
                    } else {
                        file_put_contents('b.txt', "没有" . $data["out_trade_no"] . "相关订单\r\t\n", FILE_APPEND);
                    }
                }
                else if($t_order=="F"){
                ...
                file_put_contents('c.txt', $data["out_trade_no"]."支付失败\r\t\n",FILE_APPEND);
            }
        }
        else{

    ...
    public function OrderCon(){
        ...
        if($id){
            ...
            if($MP_data){
                ...
                $MP_data["o_datetime"]=date("Y-m-d H:i:s",time());
                    ...
                    if ($data["u_thea"] != 0) {
                        ...
                        if($check_dis>0) {
                            ...
                            if ($money_1 != 0) {
                                ...
                                $finance = array(
                                    "f_types" => 5,
                                    "f_text" => "订单" . $MP_order["o_sn"] . "分拥",
                                    "f_price" => $money_1,
                                    "f_uid" => $data["u_thea"],
                                    "f_datetime" => date("Y-m-d", time())
                                );
